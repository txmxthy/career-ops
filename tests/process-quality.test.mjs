/**
 * tests/process-quality.test.mjs — Systematic test suite for src/scripts/process-quality.mjs
 *
 ...
 *
 * Run: node tests/process-quality.test.mjs
 */

import { parseActiveInterviews, extractFriction, aggregateProcessQuality } from '../src/scripts/process-quality.mjs';
...
// the illustrative examples in src/scripts/process-quality.mjs's header comment and
