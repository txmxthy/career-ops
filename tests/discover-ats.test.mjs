/**
 * tests/discover-ats.test.mjs — Systematic test suite for src/scripts/discover-ats.mjs
 *
 ...
 *
 * Run: node tests/discover-ats.test.mjs
 *
...
import {
  ...
  resolveCompany,
} from '../src/scripts/discover-ats.mjs';
