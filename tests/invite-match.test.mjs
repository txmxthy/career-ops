/**
 * tests/invite-match.test.mjs — regression tests for src/scripts/invite-match.mjs's ambiguous-
 ...
 *
 * Run: node tests/invite-match.test.mjs
 */
