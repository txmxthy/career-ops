 ...
 * skills. Lifted verbatim from src/scripts/upskill.mjs (the most-tested copy) so upskill,
...
// Skill tokenizer. Superset of the tech regex in src/scripts/analyze-patterns.mjs
