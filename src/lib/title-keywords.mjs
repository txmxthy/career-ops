// src/lib/title-keywords.mjs — one definition of how a `title_filter` keyword matches a
...
// drift: scan.mjs (the main pipeline) and src/scripts/openrouter-runner.mjs (the no-Claude
// path, which deliberately does not import scan.mjs because scan.mjs creates
// data/ at import time). Same reason src/lib/user-agent.mjs and src/lib/profile-language.mjs
 ...
 * src/scripts/openrouter-runner.mjs filters titles too and cannot import scan.mjs. It used
