// @ts-check
/**
 * src/lib/liveness-api.mjs — zero-token liveness check for ATS-hosted job postings.
 *
 ...
 * the Playwright check (src/lib/liveness-browser.mjs) for non-ATS pages or when the API is
