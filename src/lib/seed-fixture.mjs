 ...
 *
 * Usage:
 *   node src/lib/seed-fixture.mjs <targetDir> [--state state-v1.18]
 *   node src/lib/seed-fixture.mjs --self-test
 */
...
if (import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  if (args[0] === '--self-test') selfTest();
    ...
    console.error('Usage: node src/lib/seed-fixture.mjs <targetDir> [--state name] | --self-test');
    process.exit(1);
  }
}
