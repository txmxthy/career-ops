/**
 * src/lib/role-matcher.mjs - Shared fuzzy role-title matching for tracker scripts.
 *
 * Both `merge-tracker.mjs` and `src/scripts/dedup-tracker.mjs` decide whether two
