// Shared optional-section stripping for the CV builders (src/scripts/build-cv-html.mjs,
...
// src/lib/cv-templates.mjs still requires `{{EXPERIENCE}}` to be present in any custom
...
//      did nothing wrong. src/lib/cv-templates.mjs validates custom templates against
