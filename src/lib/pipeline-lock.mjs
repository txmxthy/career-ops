// src/lib/pipeline-lock.mjs — a cross-process advisory lock for data/pipeline.md.
//
...
// places — scan.mjs itself, scan-ats-full.mjs, and src/scripts/plugins.mjs (pipeline
 ...
 * neither reached `followup-seed.mjs`, `src/lib/portal-health-lock.mjs` or
...
export async function acquirePipelineLock(pipelinePath, options = {}) {
  ...
  // A fresh install may not have data/ yet — src/scripts/plugins.mjs's cmdRun calls
