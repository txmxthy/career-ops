...
/** Only compare against history this recent (mirrors src/scripts/detect-reposts.mjs). */
 ...
 * re-posts (src/scripts/detect-reposts.mjs territory), not cross-listings — skipped here.
 *
