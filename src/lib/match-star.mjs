...
/**
 * src/lib/match-star.mjs — Zero-LLM, zero-browser ATS behavioural question matcher.
 *
 ...
 *
 * Usage:
 *   node src/lib/match-star.mjs "Tell me about a time you led a project under pressure"
 *   node src/lib/match-star.mjs "Describe a conflict you resolved" --jd jds/acme.md
 *   node src/lib/match-star.mjs "Give an example of handling ambiguity" --top 2
 *   node src/lib/match-star.mjs --list    # list all stories with their tags
 */
...
if (!question) {
  console.error('Usage: node src/lib/match-star.mjs "<behavioural question>" [--jd <file>] [--top <n>]');
  console.error('       node src/lib/match-star.mjs --list');
  process.exit(1);
}
