 ...
 *
 * Usage:
 *   node src/scripts/verify-cv-facts.mjs <generated-cv.html|md|tex>
 *   node src/scripts/verify-cv-facts.mjs <generated-cv> --source cv.md --source article-digest.md
 *   node src/scripts/verify-cv-facts.mjs --self-test
 */

import { readFile, readText } from '../core/store.js';
...
function usage() {
  return `Usage: node src/scripts/verify-cv-facts.mjs <generated-document> [--source path] [--config path] [--json]
       node src/scripts/verify-cv-facts.mjs --self-test
