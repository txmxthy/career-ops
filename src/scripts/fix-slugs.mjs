...
/**
 * src/scripts/fix-slugs.mjs — write verify-portals.mjs's suggested ATS slug fixes back
 * into portals.yml.
 *
 ...
 *
 * Usage:
 *   node src/scripts/fix-slugs.mjs               # dry run (default, safe) — prints the diff, writes nothing
 ...
 *   node src/scripts/fix-slugs.mjs --file <path> # use a specific portals file
 *   node src/scripts/fix-slugs.mjs --help        # show this message (-h is an alias)
 */
