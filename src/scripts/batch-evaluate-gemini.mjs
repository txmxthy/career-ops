...
/**
 * src/scripts/batch-evaluate-gemini.mjs — Robust batch evaluator using Gemini SDK natively.
 * 
...
import { readFile as readStoredFile, readText } from '../core/store.js';
import { flagValue } from '../core/flags.js';
import { rejectPrivateOrInvalid } from '../lib/liveness-browser.mjs';
