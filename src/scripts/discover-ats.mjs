#!/usr/bin/env node
/**
 * src/scripts/discover-ats.mjs — Company-list → scannable ATS board resolver for career-ops
 *
 ...
 *
 * Run: node src/scripts/discover-ats.mjs --in companies.yml            (preview — writes nothing)
 *      node src/scripts/discover-ats.mjs --in companies.yml --write    (opt in: append to portals.yml)
 *      node src/scripts/discover-ats.mjs Stripe Ramp Mollie            (bare names)
 *      node src/scripts/discover-ats.mjs --in companies.yml --summary  (human table)
 *      node src/scripts/discover-ats.mjs --in companies.yml --vendors gh,ashby
 *      node src/scripts/discover-ats.mjs --self-test
 *
...
const USAGE = `Usage:
  node src/scripts/discover-ats.mjs --in companies.yml            # PREVIEW — resolve + print entries, write nothing
  node src/scripts/discover-ats.mjs --in companies.yml --write    # opt in: append resolved entries to portals.yml
  node src/scripts/discover-ats.mjs Stripe Ramp Mollie            # company names as positional args
  node src/scripts/discover-ats.mjs --in companies.yml --summary  # human-readable table
  node src/scripts/discover-ats.mjs --in companies.yml --vendors gh,ashby,lever  # restrict probes
  node src/scripts/discover-ats.mjs --in companies.yml --vendors workday         # Workday only
  node src/scripts/discover-ats.mjs --self-test                   # inline test suite
  node src/scripts/discover-ats.mjs --help                        # print this usage block
