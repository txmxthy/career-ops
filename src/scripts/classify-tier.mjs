...
/**
 * src/scripts/classify-tier.mjs — Seniority-tier classifier for job titles
 *
...
const USAGE = `Usage:
  node src/scripts/classify-tier.mjs "<job-title>"   # print the seniority tier
  node src/scripts/classify-tier.mjs --test          # run the inline test cases
  node src/scripts/classify-tier.mjs --help          # show this message
...
function runTests() {
  ...
  let failed = 0;
  console.log("Running src/scripts/classify-tier.mjs tests...");
