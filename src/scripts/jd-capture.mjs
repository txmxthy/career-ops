/**
 * src/scripts/jd-capture.mjs — Look up an archived job posting by report number.
 *
...
export function findCaptureForReport(jdsDir, reportNum, { companySlug } = {}) {
  ...
  // tell it apart from a real hit — src/scripts/outcome.mjs copies it in as the permanent
