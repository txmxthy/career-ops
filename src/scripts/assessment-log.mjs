#!/usr/bin/env node
/**
 * src/scripts/assessment-log.mjs — Skills-assessment event logger (eSkill, HackerRank, Criteria, ...)
 *
 ...
 * src/scripts/analyze-patterns.mjs the way ATS channel yield is analyzed today.
 *
 * Run: node src/scripts/assessment-log.mjs add --company <name> [--report <num>] \
 ...
 *      node src/scripts/assessment-log.mjs --summary   (human-readable)
...
const USAGE = `Usage:
  node src/scripts/assessment-log.mjs add --company <name> [--report <num>] --platform <vendor> --subject <topic> [--threshold <pct>] [--score <pct>] [--stale "<note>"]
  node src/scripts/assessment-log.mjs                         # print the assessment log as JSON
  node src/scripts/assessment-log.mjs --summary               # print a human-readable summary
  node src/scripts/assessment-log.mjs --self-test             # run the in-memory test suite
  node src/scripts/assessment-log.mjs --help                  # print this usage block and exit (-h is an alias)`;
...
function printSummary(result) {
  ...
  if (!assessments.length) {
    ...
    console.log('  Log one: node src/scripts/assessment-log.mjs add --company <name> --platform <vendor> --subject <topic>');
  } else {
    console.log('  Events:');
