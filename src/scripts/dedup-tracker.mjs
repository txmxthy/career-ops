#!/usr/bin/env node
/**
 * src/scripts/dedup-tracker.mjs — Remove duplicate entries from applications.md
 *
 ...
 * Merges notes.
 *
 * Run: node career-ops/src/scripts/dedup-tracker.mjs [--dry-run]
 */
...
// sit within the re-post window (mirrors src/scripts/detect-reposts.mjs's 90 days).
