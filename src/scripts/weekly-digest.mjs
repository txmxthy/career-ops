#!/usr/bin/env node
/**
 * src/scripts/weekly-digest.mjs — Weekly Interview Digest for career-ops
 *
 ...
 *
 * Run: node src/scripts/weekly-digest.mjs                       (JSON to stdout)
 *      node src/scripts/weekly-digest.mjs --summary              (human-readable digest)
 *      node src/scripts/weekly-digest.mjs --from 2026-07-13 --to 2026-07-19
 ...
 * `isoWeek` convention already used by `src/scripts/stats.mjs`'s scan-run trends.
 *
 ...
 * used throughout this codebase (e.g. src/scripts/detect-reposts.mjs, src/scripts/stats.mjs).
 *
...
const USAGE = `Usage:
  node src/scripts/weekly-digest.mjs                        # JSON digest for the current ISO week
  node src/scripts/weekly-digest.mjs --summary              # human-readable roll-up
  node src/scripts/weekly-digest.mjs --from <YYYY-MM-DD>    # start of the window
  node src/scripts/weekly-digest.mjs --to <YYYY-MM-DD>      # end of the window
  node src/scripts/weekly-digest.mjs --dir <path>           # a different interview-prep/sessions dir
  node src/scripts/weekly-digest.mjs --self-test            # run the built-in fixtures
  node src/scripts/weekly-digest.mjs --help                 # show this message
