...
/**
 * src/scripts/validate-untrusted-content-coverage.mjs — structural coverage check for the
 ...
 *
 * Run: node src/scripts/validate-untrusted-content-coverage.mjs
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  if (process.argv.includes('--self-test')) {
    console.log('Running src/scripts/validate-untrusted-content-coverage.mjs self-tests...');
