#!/usr/bin/env node
/**
 * src/scripts/gemini-eval.mjs — Gemini-powered Job Offer Evaluator for career-ops
 *
 ...
 *
 * Usage:
 *   node src/scripts/gemini-eval.mjs "Paste full JD text here"
...
╚══════════════════════════════════════════════════════════════════╝
  ...
  USAGE
    node src/scripts/gemini-eval.mjs "<JD text>"
    node src/scripts/gemini-eval.mjs --file ./jds/my-job.txt
    node src/scripts/gemini-eval.mjs --model gemini-3.6-flash "<JD text>"
  ...
  EXAMPLES
    ...
    node src/scripts/gemini-eval.mjs --file ./jds/openai-swe.txt
`);
  process.exit(0);
}
