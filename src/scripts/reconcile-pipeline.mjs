#!/usr/bin/env node
/**
 * src/scripts/reconcile-pipeline.mjs — Sync pipeline.md "Pendientes" with batch-state.tsv
 *
 * THE PROBLEM
 ...
 *
 * Run: node src/scripts/reconcile-pipeline.mjs [--dry-run] [--state <path>] [--pipeline <path>]
 */
...
if (hasFlag(ARGS, '-h') || hasFlag(ARGS, '--help')) {
  console.log('Usage: node src/scripts/reconcile-pipeline.mjs [--dry-run] [--state <path>] [--pipeline <path>]');
