...
/**
 * src/scripts/outcome.mjs — Record application outcomes, archive artifacts, and sync tracker (#1722).
 *
 * Usage:
 *   node src/scripts/outcome.mjs <report#|company> <outcome_type> [--stage "..."] [--feedback "..."] [--note "..."] [--role "..."] [--cv "..."] [--cover "..."] [--dry-run] [--json]
 *
 * Outcomes:
...
const USAGE = `Usage: node src/scripts/outcome.mjs <report#|company> <outcome_type> [options]
