...
/**
 * src/scripts/company-funded.mjs - discover recently funded companies for manual review.
 *
...
function usage() {
  console.log(`Usage:
  node src/scripts/company-funded.mjs --dry-run
  node src/scripts/company-funded.mjs --limit 25 --months 6 --sort date
  node src/scripts/company-funded.mjs --sources techcrunch,prnewswire,guardian,hn --dry-run
