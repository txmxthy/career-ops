...
/**
 * src/scripts/validate-portals.mjs — schema/shape validator for portals.yml.
 *
 * Usage:
 *   node src/scripts/validate-portals.mjs
 *   node src/scripts/validate-portals.mjs --file templates/portals.example.yml
...
async function main() {
  ...
  if (!filePath) {
    console.error('Usage: node src/scripts/validate-portals.mjs [--file portals.yml] [--self-test]');
    process.exit(1);
  }
