#!/usr/bin/env node
/**
 * src/scripts/negotiation-roi.mjs — ROI-based salary-negotiation talking-point generator
 *
 * `src/scripts/salary-gap.mjs` tells a candidate where an offer sits relative to market
 ...
 *   on a separate, unmerged branch (`src/scripts/story-provenance-check.mjs`, PR #2948).
 ...
 *
 * Run: node src/scripts/negotiation-roi.mjs                                  (JSON)
 *      node src/scripts/negotiation-roi.mjs --summary                        (human-readable)
 *      node src/scripts/negotiation-roi.mjs --wage 45 --frequency weekly     (supply missing inputs)
 *      node src/scripts/negotiation-roi.mjs --wage 45 --occurrences 52       (direct annual count)
 *      node src/scripts/negotiation-roi.mjs --self-test
 *
