...
/**
 * src/scripts/find.mjs — resolve a company/role/number query to its full pipeline identity (#1431).
 *
 ...
 *
 * Usage:
 *   node src/scripts/find.mjs <query> [--json]
 *
 ...
 * the shared fuzzy matcher (src/lib/role-matcher.mjs) as fallback for multi-word
 * phrases.
 *
...
import { readFile, resolvePdfIndexPath } from '../core/store.js';
...
const USAGE = `Usage:
  node src/scripts/find.mjs <report# | tracker# | company/role fragment> [--json]
  node src/scripts/find.mjs --help                            # print this usage block and exit`;
...
function parseArgs(argv) {
  ...
  // names --bogus); src/scripts/find.mjs has always answered --help and exited 0, and
