...
/**
 * src/scripts/reply-watch.mjs — Classify employer replies and generate a review digest (RFC #1585).
 *
...
const USAGE = 'Usage: node src/scripts/reply-watch.mjs [path/to/candidates.json]';
