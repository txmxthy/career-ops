...
/**
 * src/scripts/sync-pdf-flags.mjs — Reconciles the tracker PDF column against data/pdf-index.tsv.
 *
 ...
 *
 * Usage:
 *   node src/scripts/sync-pdf-flags.mjs [--dry-run] [--json]
 */
...
if (unknownOptions.length > 0) {
  ...
  else console.error(`Error: ${error}\nUsage: node src/scripts/sync-pdf-flags.mjs [--dry-run] [--json]`);
  process.exit(1);
}
