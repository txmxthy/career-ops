...
/**
 * src/scripts/scan-interamt.mjs — Interamt.de scanner via Playwright
 *
 ...
 *
 * Usage:
 *   node src/scripts/scan-interamt.mjs
 *   node src/scripts/scan-interamt.mjs --dry-run
 *   node src/scripts/scan-interamt.mjs --all            # skip date filter (use for first scan)
 *   node src/scripts/scan-interamt.mjs --keyword "Softwareentwickler"
 */
