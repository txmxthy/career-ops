#!/usr/bin/env node
/**
 * src/scripts/openai-tailor.mjs — OpenAI-compatible CV Tailoring for career-ops
 *
 ...
 *
 * Usage:
 *   node src/scripts/openai-tailor.mjs --jd ./jds/my-job.txt --report reports/001-company-2026.md
 *
...
╚══════════════════════════════════════════════════════════════════╝
  ...
  USAGE
    node src/scripts/openai-tailor.mjs --jd <path> --report <path>
    node src/scripts/openai-tailor.mjs --url <base> --model <id> --jd <path> --report <path>

  OPTIONS
    --jd <path>      Path to the Job Description text file
    --report <path>  Path to the evaluation report generated by src/scripts/openai-eval.mjs
  ...
  EXAMPLES
    OPENAI_API_KEY=sk-... node src/scripts/openai-tailor.mjs --jd ./jds/job.txt --report reports/001-company-2026-01-01.md
`);
  process.exit(0);
}
...
❌  No API key for ${endpointHost}.
   Set one and re-run: OPENAI_API_KEY=your_key node src/scripts/openai-tailor.mjs ...
`);
    process.exit(1);
  }
}
