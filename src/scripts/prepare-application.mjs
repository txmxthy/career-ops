...
/**
 * src/scripts/prepare-application.mjs — ATS auto-fill for Greenhouse, Ashby, and Lever.
 *
 ...
 *
 * Usage:
 *   node src/scripts/prepare-application.mjs --url <apply_url> --pdf output/<cv>.pdf
 *   node src/scripts/prepare-application.mjs --url <apply_url> --pdf output/<cv>.pdf --cover cover.txt
 *
 * Supported ATS:
...
if (!applyUrl || !pdfPath) {
  console.error('Usage: node src/scripts/prepare-application.mjs --url <apply_url> --pdf <pdf_path> [--cover <cover_txt>]');
  process.exit(1);
}
