...
/**
 * src/scripts/validate-system-paths-coverage.mjs — structural coverage check for the
 ...
 *
 * Run: node src/scripts/validate-system-paths-coverage.mjs
...
if (process.argv.includes('--self-test')) {
  console.log('Running src/scripts/validate-system-paths-coverage.mjs self-tests...');
