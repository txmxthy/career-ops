 ...
 *
 * Run: node src/scripts/stats.mjs             (JSON to stdout)
 *      node src/scripts/stats.mjs --summary   (human-readable table)
 *
 ...
 * to tell those two cases apart; src/scripts/verify-pipeline.mjs turns them into output.
 *
...
const USAGE = `Usage:
  node src/scripts/stats.mjs             # full JSON stats to stdout
  node src/scripts/stats.mjs --summary   # human-readable table
  node src/scripts/stats.mjs --help|-h   # print this usage block and exit`;
