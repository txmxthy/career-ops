...
const SYSTEM_PATHS = [
  ...
  'GEMINI.md',
  'KIMI.md',
  'src/scripts/build-dashboard.mjs',
  'generate-pdf.mjs',
  'src/lib/theme-style.mjs',
  'src/scripts/generate-latex.mjs',
  'src/lib/extract-latex-content.mjs',
  'src/lib/patch-latex-content.mjs',
  'lib/ascii-fold.mjs',
  'lib/cli-flags.mjs',
  'lib/gemini-node-floor.mjs',
  'lib/local-today.mjs',
  'lib/latex-escape.mjs',
  'src/scripts/scan-hn.mjs',
  'scripts/check-syntax.mjs',
  'src/scripts/story-provenance-check.mjs',
  'lib/latex-content.mjs',
  'lib/context-budget.mjs',
  'lib/context-budget.test.mjs',
  'lib/golden-budget-analysis.mjs',
  'src/scripts/img-to-pdf.mjs',
  'src/scripts/archive-posting.mjs',
  'src/scripts/jd-capture.mjs',
  'src/scripts/application-answers.mjs',
  'src/scripts/generate-cover-letter.mjs',
  'merge-tracker.mjs',
  'src/lib/url-key.mjs',
  'src/scripts/sync-pdf-flags.mjs',
  'src/scripts/tracker-links.mjs',
  'tracker.mjs',
  'src/scripts/find.mjs',
  'src/scripts/verify-pipeline.mjs',
  'src/scripts/reconcile-pipeline.mjs',
  'src/scripts/dedup-tracker.mjs',
  'src/scripts/add-entry.mjs',
  'src/lib/role-matcher.mjs',
  'tracker-utils.mjs',
  'tracker-parse.mjs',
  'tracker-aliases.json',
  'set-status.mjs',
  'tests/set-status.test.mjs',
  'mark-pdf-ready.mjs',
  'src/scripts/normalize-statuses.mjs',
  'src/scripts/cv-sync-check.mjs',
  'src/scripts/verify-cv-facts.mjs',
  'update-system.mjs',
  'reserve-report-num.mjs',
  'scan.mjs',
  'src/lib/pipeline-lock.mjs',
  'src/lib/portal-health-lock.mjs',
  'src/scripts/classify-tier.mjs',
  'scan-ats-full.mjs',
  'src/scripts/scan-interamt.mjs',
  'src/scripts/company-funded.mjs',
  'src/lib/match-star.mjs',
  'src/scripts/jd-skill-gap.mjs',
  'src/scripts/prepare-application.mjs',
  'src/scripts/application-artifacts.mjs',
  'src/scripts/batch-evaluate-gemini.mjs',
  'bin/',
  'providers/',
  'seeds/',
  'src/',
  'tests/',
  'src/lib/user-agent.mjs',
  'doctor.mjs',
  'src/lib/jsonc-parse.mjs',
  'src/scripts/check-liveness.mjs',
  'src/lib/liveness-core.mjs',
  'src/lib/liveness-api.mjs',
  'src/lib/liveness-browser.mjs',
  'src/scripts/browser-extract.mjs',
  'src/scripts/analyze-patterns.mjs',
  'src/scripts/upskill.mjs',
  'src/lib/skill-extract.mjs',
  'src/scripts/intake.mjs',
  'src/scripts/stats.mjs',
  'src/scripts/detect-reposts.mjs',
  'src/scripts/rank-pipeline.mjs',
  ...
  'src/scripts/company-history.mjs',
  'tests/company-history.test.mjs',
  'src/scripts/rejection-latency.mjs',
  'src/scripts/salary-gap.mjs',
  'src/scripts/negotiation-roi.mjs',
  'src/scripts/funnel-velocity.mjs',
  'src/scripts/assessment-log.mjs',
  'src/scripts/contacts.mjs',
  'tests/contacts.test.mjs',
  'src/scripts/weekly-digest.mjs',
  'src/scripts/tracker-sync-check.mjs',
  'followup-cadence.mjs',
  'tests/followup-cadence.test.mjs',
  'src/scripts/invite-match.mjs',
  'tests/invite-match.test.mjs',
  'src/scripts/agent-inbox.mjs',
  'followup-seed.mjs',
  'tests/followup-seed.test.mjs',
  'src/lib/profile-language.mjs',
  'src/lib/title-keywords.mjs',
  'src/scripts/gemini-eval.mjs',
  'src/scripts/ollama-eval.mjs',
  'src/scripts/openai-eval.mjs',
  'src/scripts/openai-tailor.mjs',
  'src/scripts/eval-golden.mjs',
  'evals/',
  'src/scripts/openrouter-runner.mjs',
  'src/scripts/jd-similarity.mjs',
  ...
  'tests/tracker-writer-lock.test.mjs',
  'tests/agent-inbox.test.mjs',
  'src/scripts/validate-portals.mjs',
  'verify-portals.mjs',
  ...
  'src/scripts/reply-matcher.mjs',
  'tests/reply-matcher.test.mjs',
  'src/scripts/reply-watch.mjs',
  'src/scripts/paste-reply.mjs',
  'tests/paste-reply.test.mjs',
  'src/scripts/outcome.mjs',
  ...
  'src/scripts/build-cv-html.mjs',
  'src/lib/cv-sections-core.mjs',
  'src/lib/cv-templates.mjs',
  'src/scripts/playwright.cv.config.mjs',
 ...
 * doing it silently. Mirrors src/scripts/discover-ats.mjs and followup-seed.mjs.
 *
 ...
 * src/scripts/agent-inbox.mjs:ensureGitignored() already applies to its own single rule,
...
async function apply() {
  ...
  try {
    ...
    try {
      ...
      // routine state rather than an exotic one: src/scripts/agent-inbox.mjs's own
...
// (e.g. from tests/run-all.mjs to exercise SEMVER_RE) does not trigger a
// live update check.
