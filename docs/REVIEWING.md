...
2. **Written doctrine beats personal taste.** Review against what the repo says (.github/CONTRIBUTING.md, DATA_CONTRACT.md, AGENTS.md, the mode files), not against how you'd have written it. If the doctrine is missing or wrong, that's an issue to open, not a review comment to enforce.
