<p align="center"><picture><source media="(prefers-color-scheme: dark)" srcset="../wordmark-dark.svg"><img src="../wordmark-light.svg" alt="career-ops" width="250" height="56"></picture></p>
...
<p align="center">
  <a href="https://x.com/santifer"><img src="../hero-banner.jpg" alt="career-ops Multi-Agent Job Search System" width="800"></a>
</p>
...
<p align="center">
  <a href="https://www.producthunt.com/products/santifer-io?utm_source=badge-featured&utm_medium=badge" target="_blank" rel="noopener noreferrer"><img src="../press/producthunt.svg" alt="career-ops on Claude | Product Hunt" style="width: 206px; height: 54px; vertical-align: middle;" width="206" height="54"/></a>
</p>

<p align="center"><sub>BASINDA</sub></p>

<p align="center">
  <a href="https://wired.com.gr/article/to-ai-ergaleio-pou-fernei-epanastasi-ston-tropo-pou-psachnoume-douleia/" rel="noopener noreferrer nofollow"><picture><source media="(prefers-color-scheme: dark)" srcset="../press/wired-dark.svg"><img src="../press/wired.svg" alt="WIRED" height="32"></picture></a>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://www.businessinsider.com/how-i-built-tool-filter-job-listings-landed-head-ai-2026-4" rel="noopener noreferrer nofollow"><picture><source media="(prefers-color-scheme: dark)" srcset="../press/business-insider-dark.svg"><img src="../press/business-insider.svg" alt="Business Insider" height="32"></picture></a>
</p>

---

<p align="center">
  <img src="../demo.gif" alt="career-ops Demo" width="800">
</p>
...
<p align="center">
  <sub>Agent-skill standardını destekleyen her CLI'de de çalışır. Bkz. <a href="../SUPPORTED_CLIS.md">Desteklenen CLI'ler</a>.</sub><br>
...
Tam kurulum kılavuzu için [docs/SETUP.md](../SETUP.md)'ye, özel veya yerel modeller kullanarak career-ops'u ucuza çalıştırma talimatları için [docs/RUNNING_ON_A_BUDGET.md](../RUNNING_ON_A_BUDGET.md)'ye, ATS otomatik doldurma akışının ayrıntıları için [docs/APPLY_AUTOFILL.md](../APPLY_AUTOFILL.md)'ye ve sık sorulan kurulum sorularının yanıtları için [docs/FAQ.md](../FAQ.md)'ye bakın.
...
career-ops, Codex'i aynı paylaşılan yönlendirici üzerinden destekler, ancak çağırma modeli slash komutlarını otomatik kaydeden CLI'lerden farklıdır. Tam kılavuz için bkz. [docs/CODEX.md](../CODEX.md).
...
**Taranan iş panoları:** ATS API'lerini, pano geneli beslemeleri, XML/RSS beslemelerini, markdown beslemelerini ve yerel ayrıştırıcıları kapsayan 21 sağlayıcı modülü. Tam tablo için bkz. [Desteklenen iş panoları](../SUPPORTED_JOB_BOARDS.md).
...
Evet. career-ops CLI'den bağımsızdır ve ücretsiz ile yerel modellerde çalışır -- OpenRouter ücretsiz modelleri, Ollama veya herhangi bir OpenAI uyumlu uç nokta üzerinden -- bu yüzden ücretli bir aboneliğe bağlı değilsiniz. Tam kurulum için bkz. [docs/RUNNING_ON_A_BUDGET.md](../RUNNING_ON_A_BUDGET.md).
...
career-ops Windows'ta çalışır. Kurulum sırasında skill'ler bir sembolik bağlantı hatasıyla yüklenemezse, çözüm [docs/FAQ.md](../FAQ.md) içinde. Tam adımlar için bkz. [docs/SETUP.md](../SETUP.md).
