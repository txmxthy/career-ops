...
<p align="center">
  <a href="https://x.com/santifer"><img src="../hero-banner.jpg" alt="career-ops Мультиагентная система поиска работы" width="800"></a>
</p>
...
<p align="center">
  ...
  &nbsp;&nbsp;
  <a href="https://www.producthunt.com/products/santifer-io?utm_source=badge-featured&utm_medium=badge" target="_blank"><img src="../press/producthunt.svg" alt="career-ops on Claude | Product Hunt" style="width: 206px; height: 54px; vertical-align: middle;" width="206" height="54"/></a>
</p>
...
<p align="center">
  <img src="../demo.gif" alt="career-ops Демо" width="800">
</p>
...
Да. career-ops не привязан к конкретному CLI и работает с бесплатными и локальными моделями — через OpenRouter, Ollama или любой другой OpenAI-совместимой точкой доступа — поэтому платная подписка необязательна. Ознакомиться с полной настройкой можно в [docs/RUNNING_ON_A_BUDGET.md](../RUNNING_ON_A_BUDGET.md)
...
career-ops работает на Windows. Если навыки не загружаются из-за ошибки с символическими ссылками (symlink error) во время установки, ознакомьтесь с решением в [docs/FAQ.md](../FAQ.md). Полная инструкция в [docs/SETUP.md](../SETUP.md).
