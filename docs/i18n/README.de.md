...
<p align="center">
  <a href="https://x.com/santifer"><img src="../hero-banner.jpg" alt="career-ops Multi-Agent-System für die Jobsuche" width="800"></a>
</p>
...
<p align="center">
  <a href="https://www.producthunt.com/products/santifer-io?utm_source=badge-featured&utm_medium=badge" target="_blank" rel="noopener noreferrer"><img src="../press/producthunt.svg" alt="career-ops auf Claude | Product Hunt" style="width: 206px; height: 54px; vertical-align: middle;" width="206" height="54"/></a>
</p>
...
Siehe [docs/SETUP.md](../SETUP.md) für die vollständige Setup-Anleitung und [docs/RUNNING_ON_A_BUDGET.md](../RUNNING_ON_A_BUDGET.md) für günstige Nutzung mit eigenen oder lokalen Modellen.
...
**Durchsuchte Jobbörsen:** 21 Provider-Module decken ATS-APIs, boardweite Feeds, XML/RSS-Feeds, Markdown-Feeds und lokale Parser ab. Siehe [Supported job boards](../SUPPORTED_JOB_BOARDS.md) für die vollständige Tabelle.
...
career-ops läuft unter Windows. Falls Skills während der Installation mit einem Symlink-Fehler nicht laden, steht die Lösung in [docs/FAQ.md](../FAQ.md). Die vollständigen Schritte findest du in [docs/SETUP.md](../SETUP.md).
