...
Veja [docs/SETUP.md](../SETUP.md) para o guia completo de configuração.
...
O career-ops roda no Windows. Se o carregamento de habilidades falhar com um erro de symlink durante a instalação, a correção está em [docs/FAQ.md](../FAQ.md). O passo a passo completo está em [docs/SETUP.md](../SETUP.md).
